...
async def start_cmd(message: Message):
    await message.answer(
        ...
        "/setadmin @username – הוספת מנהל\n"
        "/deleteadmin @username – הסרת מנהל\n"
        "/approve @username או בתגובה – אישור משתמש\n"
        "/remove @username – הסרת משתמש מאושר\n"
        "/list – רשימת מאושרים\n"
        "/adminlist – רשימת מנהלים\n\n"
        "נוצר באהבה על ידי @OrHsOaH"
    )
